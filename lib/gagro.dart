...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    if (json['data_list'] != null) {
      ...
      json['data_list'].forEach((v) { dataList.add(new DataList.fromJson(v)); });
    }
  }
...
class DataList {
  ...
  DataList.fromJson(Map<String, dynamic> json) {
    ...
    if (json['child'] != null) {
      ...
      json['child'].forEach((v) { childList.add(new Child.fromJson(v)); });
    }
  }
...
class Child {
  ...
  Child.fromJson(Map<String, dynamic> json) {
    ...
    if (json['child'] != null) {
      ...
      json['child'].forEach((v) { child.add(new Child2.fromJson(v)); });
    }
  }
